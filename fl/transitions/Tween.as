...
public class Tween extends EventDispatcher
{
	...
	public function set time(t:Number):void 
	{
		...
		if (t > this.duration) {
			if (this.looping) {
				...
				this.update();
				this.dispatchEvent(new TweenEvent(TweenEvent.MOTION_LOOP, this._time, this._position, this.obj));
			} else {
				if (this.useSeconds) {
				...
				this.stop();
				this.dispatchEvent(new TweenEvent(TweenEvent.MOTION_FINISH, this._time, this._position, this.obj));
			}
		} else if (t < 0) {
			this.rewind();
			this.update();
	...
	public function setPosition(p:Number):void 
	{
		...
		this.dispatchEvent(new TweenEvent(TweenEvent.MOTION_CHANGE, this._time, this._position, this.obj));	
	}
...
/////////////////////////////////////////////////////////////////////////
	...
	public function start():void 
	{
		this.rewind();
		this.startEnterFrame();
		this.dispatchEvent(new TweenEvent(TweenEvent.MOTION_START, this._time, this._position, this.obj));
	}
	...
	{
		this.stopEnterFrame();
		this.dispatchEvent(new TweenEvent(TweenEvent.MOTION_STOP, this._time, this._position, this.obj));
	}
	...
	public function resume():void 
	{
		this.fixTime();
		this.startEnterFrame();
		this.dispatchEvent(new TweenEvent(TweenEvent.MOTION_RESUME, this._time, this._position, this.obj));
	}
